...
use crate::isa::{MAX_ENUM_VARIANTS, MAX_ENUMS, MAX_VARS, MAX_BYTECODE_SIZE, MAX_STRING_POOL, MAX_CONST_POOL, PX64_HEADER_SIZE, NATIVE_MATH_MIN, NATIVE_MATH_MAX, NATIVE_MATH_ABS, NATIVE_MATH_CLAMP, NATIVE_BIT_POPCNT, NATIVE_BIT_LZCNT, NATIVE_CRC32, NATIVE_VRAM_READ, NATIVE_VRAM_WRITE, NATIVE_FIX_TO_FIX, NATIVE_FIX_TO_I64, NATIVE_FIX_MUL, NATIVE_FIX_DIV, NATIVE_NET_SEND, PX64_OP_CALL_NAT, PX64_OP_MOV_REG, PX64_OP_SUB, PX64_OP_CMP_EQ};
